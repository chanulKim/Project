						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#facilitymanagement-display"
								}
							}]
						}]
					}
					...
					"config": {
						"inbounds": {
							"facilitymanagement-display": {
								"semanticObject": "facilitymanagement",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=facilitymanagement",
									"url": sap.ui.require.toUrl("facilitymanagement")
								}
							}
						}
					}
