		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "housemanaging",
									"targetURL": "#housemanaging-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"housemanaging-display": {
								"semanticObject": "housemanaging",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=housemanaging",
									"url": sap.ui.require.toUrl("housemanaging")
								}
							}
						}
					}
